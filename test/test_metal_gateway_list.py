...
import metal
from metal.types.metal_gateway_list import MetalGatewayList  # noqa: E501
...
class TestMetalGatewayList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = metal.models.metal_gateway_list.MetalGatewayList()  # noqa: E501
        if include_optional :
            return MetalGatewayList(
                metal_gateways = [
                    metal.models.metal_gateway.MetalGateway(
                        id = '', 
                        state = 'ready', 
