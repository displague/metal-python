...
import metal
from metal.types.metal_gateway import MetalGateway  # noqa: E501
...
class TestMetalGateway(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = metal.models.metal_gateway.MetalGateway()  # noqa: E501
        if include_optional :
            return MetalGateway(
                ...
                href = '', 
                id = '', 
                ip_reservation = metal.models.ip_reservation.IPReservation(
                    addon = True, 
                    address = '', 
                    address_family = 56, 
                    assignments = [
