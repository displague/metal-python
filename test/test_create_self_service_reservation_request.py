...
import metal
from metal.types.create_self_service_reservation_request import CreateSelfServiceReservationRequest  # noqa: E501
...
class TestCreateSelfServiceReservationRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = metal.models.create_self_service_reservation_request.CreateSelfServiceReservationRequest()  # noqa: E501
        if include_optional :
            return CreateSelfServiceReservationRequest(
                item = [
                    metal.models.self_service_reservation_item_request.SelfServiceReservationItemRequest(
                        amount = 1.337, 
                        metro_id = '', 
                        plan_id = '', 
                        quantity = 56, 
