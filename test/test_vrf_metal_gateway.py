...
import metal
from metal.types.vrf_metal_gateway import VrfMetalGateway  # noqa: E501
...
class TestVrfMetalGateway(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = metal.models.vrf_metal_gateway.VrfMetalGateway()  # noqa: E501
        if include_optional :
            return VrfMetalGateway(
                ...
                href = '', 
                id = '', 
                ip_reservation = metal.models.vrf_ip_reservation.VrfIpReservation(
                    address_family = 56, 
                    cidr = 56, 
                    created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    created_by = metal.models.href.Href(
                    ...
                    href = '', 
                    id = '', 
                    metal_gateway = metal.models.metal_gateway_lite.MetalGatewayLite(
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    ...
                    customdata = metal.models.customdata.customdata(), 
                    bill = True, 
                    project_lite = metal.models.project.Project(
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        customdata = metal.models.customdata.customdata(), 
                        id = '', 
                        max_devices = metal.models.max_devices.max_devices(), 
                ...
                state = 'ready', 
                updated_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                virtual_network = metal.models.virtual_network.VirtualNetwork(
                ...
                vrf = metal.models.vrf.Vrf(
                    ...
                    metro = metal.models.metro.Metro(
                        ...
                        id = '', 
                        name = '', ), 
                    created_by = metal.models.user.User(
                        avatar_thumb_url = '', 
                        avatar_url = '', 
                        created_at = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        customdata = metal.models.customdata.customdata(), 
