...
import metal
from metal.types.self_service_reservation_list import SelfServiceReservationList  # noqa: E501
...
class TestSelfServiceReservationList(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = metal.models.self_service_reservation_list.SelfServiceReservationList()  # noqa: E501
        if include_optional :
            return SelfServiceReservationList(
                reservations = [
                    metal.models.self_service_reservation_response.SelfServiceReservationResponse(
                        status = '', 
