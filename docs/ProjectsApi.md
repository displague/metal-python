...
with metal.ApiClient(configuration) as api_client:
    ...
    project_create_from_root_input = metal.ProjectCreateFromRootInput() # ProjectCreateFromRootInput | Project to create
...
transfer_request_input = metal.TransferRequestInput() # TransferRequestInput | Transfer Request to create
...
with metal.ApiClient(configuration) as api_client:
    ...
    api_instance = metal.ProjectsApi(api_client)
    id = 'id_example' # str | Project UUID
project_update_input = metal.ProjectUpdateInput() # ProjectUpdateInput | Project to update
