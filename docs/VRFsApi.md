...
with metal.ApiClient(configuration) as api_client:
    ...
    api_instance = metal.VRFsApi(api_client)
    id = 'id_example' # str | Project UUID
vrf_create_input = metal.VrfCreateInput() # VrfCreateInput | VRF to create
...
vrf_route_create_input = metal.VrfRouteCreateInput() # VrfRouteCreateInput | 
...
with metal.ApiClient(configuration) as api_client:
    ...
    api_instance = metal.VRFsApi(api_client)
    id = 'id_example' # str | VRF UUID
vrf_update_input = metal.VrfUpdateInput() # VrfUpdateInput | VRF to update
