...
from ..models.metal_gateway_state import MetalGatewayState
...
T = TypeVar("T", bound="MetalGateway")
...
class MetalGateway:
    ...
    Attributes:
        ...
        id (Union[Unset, str]):
        ip_reservation (Union[Unset, IPReservation]):
        project (Union[Unset, Project]):
        state (Union[Unset, MetalGatewayState]): The current state of the Metal Gateway. 'Ready' indicates the gateway
            record has been configured, but is currently not active on the network. 'Active' indicates the gateway has been
            configured on the network. 'Deleting' is a temporary state used to indicate that the gateway is in the process
            of being un-configured from the network, after which the gateway record will be deleted.
    ...
    ip_reservation: Union[Unset, 'IPReservation'] = UNSET
    project: Union[Unset, 'Project'] = UNSET
    state: Union[Unset, MetalGatewayState] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_ip_reservation,  Unset):
            ...
            ip_reservation = IPReservation.from_dict(_ip_reservation)
        ...
        state: Union[Unset, MetalGatewayState]
        if isinstance(_state,  Unset):
            state = UNSET
        else:
            state = MetalGatewayState(_state)
        ...
        metal_gateway.additional_properties = d
