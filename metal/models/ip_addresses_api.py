...
class IPAddressesApi(object):
    ...
    def find_ip_availabilities_with_http_info(self, id, cidr, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and local_var_params.get('cidr') is None:  # noqa: E501
        ...
        query_params = []
        if local_var_params.get('cidr') is not None:  # noqa: E501
    ...
    def find_ip_reservations_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `find_ip_reservations`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'per_page' in local_var_params and local_var_params['per_page'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `per_page` when calling `find_ip_reservations`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def request_ip_reservation(self, id, request_ip_reservation_request, **kwargs):  # noqa: E501
    ...
    def request_ip_reservation_with_http_info(self, id, request_ip_reservation_request, **kwargs):  # noqa: E501
        """Requesting IP reservations  # noqa: E501
        ...
        # verify the required parameter 'request_ip_reservation_request' is set
        if self.api_client.client_side_validation and local_var_params.get('request_ip_reservation_request') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `request_ip_reservation_request` when calling `request_ip_reservation`")  # noqa: E501
        ...
        body_params = None
        if 'request_ip_reservation_request' in local_var_params:
            body_params = local_var_params['request_ip_reservation_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def update_ip_address(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_ip_address(id, async_req=True)
        >>> result = thread.get()
    ...
    def update_ip_address_with_http_info(self, id, **kwargs):  # noqa: E501
        """Update an ip address  # noqa: E501
        ...
        >>> thread = api.update_ip_address_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        body_params = None
        if 'ip_assignment_update_input' in local_var_params:
            body_params = local_var_params['ip_assignment_update_input']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
