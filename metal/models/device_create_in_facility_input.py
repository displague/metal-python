...
T = TypeVar("T", bound="DeviceCreateInFacilityInput")
...
class DeviceCreateInFacilityInput:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        device_create_in_facility_input = cls(
            facility=facility,
            operating_system=operating_system,
            plan=plan,
        ...
        device_create_in_facility_input.additional_properties = d
        return device_create_in_facility_input
