...
class MembershipsApi(object):
    ...
    def update_membership(self, id, membership_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_membership(id, membership_input, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_membership_with_http_info(id, membership_input, **kwargs)  # noqa: E501

    def update_membership_with_http_info(self, id, membership_input, **kwargs):  # noqa: E501
        """Update the membership  # noqa: E501
        ...
        >>> thread = api.update_membership_with_http_info(id, membership_input, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'membership_input' is set
        if self.api_client.client_side_validation and local_var_params.get('membership_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `membership_input` when calling `update_membership`")  # noqa: E501
        ...
        body_params = None
        if 'membership_input' in local_var_params:
            body_params = local_var_params['membership_input']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
