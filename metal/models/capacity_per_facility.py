...
T = TypeVar("T", bound="CapacityPerFacility")

@attr.s(auto_attribs=True)
class CapacityPerFacility:
    """
    Attributes:
        baremetal_0 (Union[Unset, CapacityLevelPerBaremetal]):
        baremetal_1 (Union[Unset, CapacityLevelPerBaremetal]):
        baremetal_2 (Union[Unset, CapacityLevelPerBaremetal]):
        baremetal_2a (Union[Unset, CapacityLevelPerBaremetal]):
        baremetal_2a2 (Union[Unset, CapacityLevelPerBaremetal]):
        baremetal_3 (Union[Unset, CapacityLevelPerBaremetal]):
        baremetal_s (Union[Unset, CapacityLevelPerBaremetal]):
        c2_medium_x86 (Union[Unset, CapacityLevelPerBaremetal]):
        m2_xlarge_x86 (Union[Unset, CapacityLevelPerBaremetal]):
    """

    baremetal_0: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    baremetal_1: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    baremetal_2: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    baremetal_2a: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    baremetal_2a2: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    baremetal_3: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    baremetal_s: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    c2_medium_x86: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    m2_xlarge_x86: Union[Unset, 'CapacityLevelPerBaremetal'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_baremetal_0,  Unset):
            ...
            baremetal_0 = CapacityLevelPerBaremetal.from_dict(_baremetal_0)
        ...
        if isinstance(_baremetal_1,  Unset):
            ...
            baremetal_1 = CapacityLevelPerBaremetal.from_dict(_baremetal_1)
        ...
        if isinstance(_baremetal_2,  Unset):
            ...
            baremetal_2 = CapacityLevelPerBaremetal.from_dict(_baremetal_2)
        ...
        if isinstance(_baremetal_2a,  Unset):
            ...
            baremetal_2a = CapacityLevelPerBaremetal.from_dict(_baremetal_2a)
        ...
        if isinstance(_baremetal_2a2,  Unset):
            ...
            baremetal_2a2 = CapacityLevelPerBaremetal.from_dict(_baremetal_2a2)
        ...
        if isinstance(_baremetal_3,  Unset):
            ...
            baremetal_3 = CapacityLevelPerBaremetal.from_dict(_baremetal_3)
        ...
        if isinstance(_baremetal_s,  Unset):
            ...
            baremetal_s = CapacityLevelPerBaremetal.from_dict(_baremetal_s)
        ...
        if isinstance(_c2_medium_x86,  Unset):
            ...
            c2_medium_x86 = CapacityLevelPerBaremetal.from_dict(_c2_medium_x86)
        ...
        if isinstance(_m2_xlarge_x86,  Unset):
            ...
            m2_xlarge_x86 = CapacityLevelPerBaremetal.from_dict(_m2_xlarge_x86)




        capacity_per_facility = cls(
        ...
        capacity_per_facility.additional_properties = d
        return capacity_per_facility
