...
T = TypeVar("T", bound="PlanAvailableInInner")

@attr.s(auto_attribs=True)
class PlanAvailableInInner:
    """
    Attributes:
        href (Union[Unset, str]): href to the Facility
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        plan_available_in_inner = cls(
            href=href,
            price=price,
        )

        plan_available_in_inner.additional_properties = d
        return plan_available_in_inner
