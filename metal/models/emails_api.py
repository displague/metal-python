...
class EmailsApi(object):
    ...
    def create_email(self, create_email_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_email(create_email_input, async_req=True)
        >>> result = thread.get()
    ...
    def create_email_with_http_info(self, create_email_input, **kwargs):  # noqa: E501
        """Create an email  # noqa: E501
        ...
        >>> thread = api.create_email_with_http_info(create_email_input, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'create_email_input' is set
        if self.api_client.client_side_validation and local_var_params.get('create_email_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `create_email_input` when calling `create_email`")  # noqa: E501
        ...
        body_params = None
        if 'create_email_input' in local_var_params:
            body_params = local_var_params['create_email_input']
        # HTTP header `Accept`
    ...
    def update_email(self, id, update_email_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_email(id, update_email_input, async_req=True)
        >>> result = thread.get()
    ...
    def update_email_with_http_info(self, id, update_email_input, **kwargs):  # noqa: E501
        """Update the email  # noqa: E501
        ...
        >>> thread = api.update_email_with_http_info(id, update_email_input, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'update_email_input' is set
        if self.api_client.client_side_validation and local_var_params.get('update_email_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `update_email_input` when calling `update_email`")  # noqa: E501
        ...
        body_params = None
        if 'update_email_input' in local_var_params:
            body_params = local_var_params['update_email_input']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
