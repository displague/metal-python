...
T = TypeVar("T", bound="DeviceCreateInMetroInput")
...
class DeviceCreateInMetroInput:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        device_create_in_metro_input = cls(
            metro=metro,
            operating_system=operating_system,
            plan=plan,
        ...
        device_create_in_metro_input.additional_properties = d
        return device_create_in_metro_input
