...
T = TypeVar("T", bound="IPReservationFacility")

@attr.s(auto_attribs=True)
class IPReservationFacility:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ip_reservation_facility.additional_properties = d
        return ip_reservation_facility
