...
class LicensesApi(object):
    ...
    def create_license(self, id, license_create_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_license(id, license_create_input, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_license_with_http_info(id, license_create_input, **kwargs)  # noqa: E501

    def create_license_with_http_info(self, id, license_create_input, **kwargs):  # noqa: E501
        """Create a License  # noqa: E501
        ...
        >>> thread = api.create_license_with_http_info(id, license_create_input, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'license_create_input' is set
        if self.api_client.client_side_validation and local_var_params.get('license_create_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `license_create_input` when calling `create_license`")  # noqa: E501
        ...
        body_params = None
        if 'license_create_input' in local_var_params:
            body_params = local_var_params['license_create_input']
        # HTTP header `Accept`
    ...
    def update_license(self, id, license_update_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_license(id, license_update_input, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_license_with_http_info(id, license_update_input, **kwargs)  # noqa: E501

    def update_license_with_http_info(self, id, license_update_input, **kwargs):  # noqa: E501
        """Update the license  # noqa: E501
        ...
        >>> thread = api.update_license_with_http_info(id, license_update_input, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'license_update_input' is set
        if self.api_client.client_side_validation and local_var_params.get('license_update_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `license_update_input` when calling `update_license`")  # noqa: E501
        ...
        body_params = None
        if 'license_update_input' in local_var_params:
            body_params = local_var_params['license_update_input']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
