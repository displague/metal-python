...
class VLANsApi(object):
    ...
    def create_virtual_network(self, id, virtual_network_create_input, **kwargs):  # noqa: E501
    ...
    def create_virtual_network_with_http_info(self, id, virtual_network_create_input, **kwargs):  # noqa: E501
        """Create a virtual network  # noqa: E501
        ...
        # verify the required parameter 'virtual_network_create_input' is set
        if self.api_client.client_side_validation and local_var_params.get('virtual_network_create_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `virtual_network_create_input` when calling `create_virtual_network`")  # noqa: E501
        ...
        body_params = None
        if 'virtual_network_create_input' in local_var_params:
            body_params = local_var_params['virtual_network_create_input']
        # HTTP header `Accept`
