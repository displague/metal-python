...
class CapacityApi(object):
    ...
    def check_capacity_for_facility(self, capacity_input, **kwargs):  # noqa: E501
    ...
    def check_capacity_for_facility_with_http_info(self, capacity_input, **kwargs):  # noqa: E501
        """Check capacity  # noqa: E501
        ...
        # verify the required parameter 'capacity_input' is set
        if self.api_client.client_side_validation and local_var_params.get('capacity_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `capacity_input` when calling `check_capacity_for_facility`")  # noqa: E501
        ...
        body_params = None
        if 'capacity_input' in local_var_params:
            body_params = local_var_params['capacity_input']
        # HTTP header `Accept`
    ...
    def check_capacity_for_metro(self, capacity_per_metro_input, **kwargs):  # noqa: E501
        ...
        >>> thread = api.check_capacity_for_metro(capacity_per_metro_input, async_req=True)
        >>> result = thread.get()

        :param capacity_per_metro_input: Metro to check capacity in (required)
        :type capacity_per_metro_input: CapacityPerMetroInput
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.check_capacity_for_metro_with_http_info(capacity_per_metro_input, **kwargs)  # noqa: E501

    def check_capacity_for_metro_with_http_info(self, capacity_per_metro_input, **kwargs):  # noqa: E501
        """Check capacity for a metro  # noqa: E501
        ...
        >>> thread = api.check_capacity_for_metro_with_http_info(capacity_per_metro_input, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            ...
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'capacity_per_metro_input' is set
        if self.api_client.client_side_validation and local_var_params.get('capacity_per_metro_input') is None:  # noqa: E501
            raise ApiValueError("Missing the required parameter `capacity_per_metro_input` when calling `check_capacity_for_metro`")  # noqa: E501
        ...
        body_params = None
        if 'capacity_per_metro_input' in local_var_params:
            body_params = local_var_params['capacity_per_metro_input']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
