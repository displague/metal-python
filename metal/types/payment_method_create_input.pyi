...
class PaymentMethodCreateInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "nonce", "default", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "nonce", "default", ], str]):
