...
class Error(object):
    ...
    def __init__(self, error=None, errors=None, local_vars_configuration=None):  # noqa: E501
    ...
    def error(self):
        ...
        A description of the error that caused the request to fail.  # noqa: E501
    ...
    def errors(self):
        ...
        A list of errors that contributed to the request failing.  # noqa: E501
