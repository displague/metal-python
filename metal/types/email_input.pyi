...
class EmailInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "default", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "default", ], str]):
