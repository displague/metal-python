...
class PlanSpecsDrivesInner(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "type", "size", "category", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "type", "size", "category", ], str]):
