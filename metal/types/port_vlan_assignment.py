...
class PortVlanAssignment(object):
    ...
    def __init__(self, created_at=None, id=None, native=None, port=None, state=None, updated_at=None, virtual_network=None, vlan=None, local_vars_configuration=None):  # noqa: E501
