...
class InstancesBatchCreateInputBatchesInnerAllOf(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["hostnames", "quantity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hostnames", "quantity", ], str]):
