...
class IPAssignmentUpdateInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["details", "customdata", "tags", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["details", "customdata", "tags", ], str]):
