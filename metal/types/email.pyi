...
class Email(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "default", "href", "id", "verified", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "default", "href", "id", "verified", ], str]):
