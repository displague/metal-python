...
class ProjectCreateFromRootInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "customdata", "organization_id", "payment_method_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "customdata", "organization_id", "payment_method_id", ], str]):
