...
class CapacityCheckPerFacilityInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["available", "facility", "plan", "quantity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["available", "facility", "plan", "quantity", ], str]):
