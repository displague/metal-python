...
class ProjectList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "projects", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "projects", ], str]):
