...
class DeviceUsage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["quantity", "total", "unit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["quantity", "total", "unit", ], str]):
