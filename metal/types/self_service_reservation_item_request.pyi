...
class SelfServiceReservationItemRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "metro_id", "plan_id", "quantity", "term", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "metro_id", "plan_id", "quantity", "term", ], str]):
