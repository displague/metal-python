...
class InterconnectionUpdateInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["contact_email", "description", "mode", "name", "redundancy", "tags", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["contact_email", "description", "mode", "name", "redundancy", "tags", ], str]):
