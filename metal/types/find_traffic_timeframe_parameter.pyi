...
class FindTrafficTimeframeParameter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ended_at", "started_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ended_at", "started_at", ], str]):
