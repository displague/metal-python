...
class ProjectUsage(object):
    ...
    def __init__(self, facility=None, name=None, plan=None, plan_version=None, price=None, quantity=None, total=None, type=None, unit=None, local_vars_configuration=None):  # noqa: E501
