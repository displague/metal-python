...
class PortVlanAssignmentBatchCreateInput(object):
    ...
    def __init__(self, vlan_assignments=None, local_vars_configuration=None):  # noqa: E501
        """PortVlanAssignmentBatchCreateInput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def vlan_assignments(self):
        """Gets the vlan_assignments of this PortVlanAssignmentBatchCreateInput.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PortVlanAssignmentBatchCreateInput):
            return False
