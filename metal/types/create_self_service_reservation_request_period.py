...
class CreateSelfServiceReservationRequestPeriod(object):
    ...
    def __init__(self, count=None, unit=None, local_vars_configuration=None):  # noqa: E501
    ...
    def count(self, count):
        ...
        if self.local_vars_configuration.client_side_validation and count not in allowed_values:  # noqa: E501
            raise ValueError(
                "Invalid value for `count` ({0}), must be one of {1}"  # noqa: E501
