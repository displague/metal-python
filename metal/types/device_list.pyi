...
class DeviceList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["devices", "meta", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["devices", "meta", ], str]):
