...
class ParentBlock(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["cidr", "href", "netmask", "network", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["cidr", "href", "netmask", "network", ], str]):
