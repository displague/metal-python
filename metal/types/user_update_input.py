...
class UserUpdateInput(object):
    ...
    def __init__(self, customdata=None, first_name=None, last_name=None, password=None, phone_number=None, timezone=None, local_vars_configuration=None):  # noqa: E501
