...
class UserUpdateInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customdata", "first_name", "last_name", "password", "phone_number", "timezone", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customdata", "first_name", "last_name", "password", "phone_number", "timezone", ], str]):
