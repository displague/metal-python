...
class MetalGateway(object):
    ...
    def __init__(self, created_at=None, created_by=None, href=None, id=None, ip_reservation=None, project=None, state=None, updated_at=None, virtual_network=None, local_vars_configuration=None):  # noqa: E501
