...
class SelfServiceReservationItemResponse(object):
    ...
    def __init__(self, amount=None, id=None, metro_code=None, metro_id=None, metro_name=None, plan_id=None, plan_name=None, plan_slug=None, quantity=None, term=None, local_vars_configuration=None):  # noqa: E501
