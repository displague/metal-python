...
class IPReservationRequestInput(object):
    ...
    def __init__(self, comments=None, customdata=None, details=None, facility=None, fail_on_approval_required=None, metro=None, quantity=None, tags=None, type=None, local_vars_configuration=None):  # noqa: E501
