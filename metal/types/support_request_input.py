...
class SupportRequestInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["message", "subject", "device_id", "priority", "project_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["message", "subject", "device_id", "priority", "project_id", ], str]):
