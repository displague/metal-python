...
class OrganizationList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "organizations", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "organizations", ], str]):
