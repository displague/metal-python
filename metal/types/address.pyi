...
class Address(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "country", "zip_code", "address2", "city", "coordinates", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "country", "zip_code", "address2", "city", "coordinates", "state", ], str]):
