...
class DeviceCreateInMetroInput(object):
    ...
    @property
    def metro(self):
        """Gets the metro of this DeviceCreateInMetroInput.  # noqa: E501

        Metro code or ID of where the instance should be provisioned in. Either metro or facility must be provided.  # noqa: E501

        :return: The metro of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
        return self._metro
    ...
    def metro(self, metro):
        """Sets the metro of this DeviceCreateInMetroInput.

        Metro code or ID of where the instance should be provisioned in. Either metro or facility must be provided.  # noqa: E501

        :param metro: The metro of this DeviceCreateInMetroInput.  # noqa: E501
        :type metro: str
        """
    ...
    @property
    def always_pxe(self):
        """Gets the always_pxe of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The always_pxe of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: bool
        """
    ...
    def always_pxe(self, always_pxe):
        """Sets the always_pxe of this DeviceCreateInMetroInput.

        When true, devices with a `custom_ipxe` OS will always boot to iPXE. The default setting of false ensures that iPXE will be used on only the first boot.  # noqa: E501

        :param always_pxe: The always_pxe of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def billing_cycle(self):
        """Gets the billing_cycle of this DeviceCreateInMetroInput.  # noqa: E501

        The billing cycle of the device.  # noqa: E501

        :return: The billing_cycle of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def billing_cycle(self, billing_cycle):
        """Sets the billing_cycle of this DeviceCreateInMetroInput.

        The billing cycle of the device.  # noqa: E501

        :param billing_cycle: The billing_cycle of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def customdata(self):
        """Gets the customdata of this DeviceCreateInMetroInput.  # noqa: E501

        Customdata is an arbitrary JSON value that can be accessed via the metadata service.  # noqa: E501

        :return: The customdata of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def customdata(self, customdata):
        """Sets the customdata of this DeviceCreateInMetroInput.

        Customdata is an arbitrary JSON value that can be accessed via the metadata service.  # noqa: E501

        :param customdata: The customdata of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The description of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this DeviceCreateInMetroInput.

        Any description of the device or how it will be used. This may be used to inform other API consumers with project access.  # noqa: E501

        :param description: The description of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def features(self):
        """Gets the features of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The features of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def features(self, features):
        """Sets the features of this DeviceCreateInMetroInput.

        The features attribute allows you to optionally specify what features your server should have.  In the API shorthand syntax, all features listed are `required`:  ``` { \"features\": [\"tpm\"] } ```  Alternatively, if you do not require a certain feature, but would prefer to be assigned a server with that feature if there are any available, you may specify that feature with a `preferred` value. The request will not fail if we have no servers with that feature in our inventory. The API offers an alternative syntax for mixing preferred and required features:  ``` { \"features\": { \"tpm\": \"required\", \"raid\": \"preferred\" } } ```  The request will only fail if there are no available servers matching the required `tpm` criteria.  # noqa: E501

        :param features: The features of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def hardware_reservation_id(self):
        """Gets the hardware_reservation_id of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The hardware_reservation_id of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def hardware_reservation_id(self, hardware_reservation_id):
        """Sets the hardware_reservation_id of this DeviceCreateInMetroInput.

        The Hardware Reservation UUID to provision. Alternatively, `next-available` can be specified to select from any of the available hardware reservations. An error will be returned if the requested reservation option is not available.  See [Reserved Hardware](https://metal.equinix.com/developers/docs/deploy/reserved/) for more details.  # noqa: E501

        :param hardware_reservation_id: The hardware_reservation_id of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def hostname(self):
        """Gets the hostname of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The hostname of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def hostname(self, hostname):
        """Sets the hostname of this DeviceCreateInMetroInput.

        The hostname to use within the operating system. The same hostname may be used on multiple devices within a project.  # noqa: E501

        :param hostname: The hostname of this DeviceCreateInMetroInput.  # noqa: E501
        :type hostname: str
        """
    ...
    def ip_addresses(self):
        """Gets the ip_addresses of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The ip_addresses of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def ip_addresses(self, ip_addresses):
        """Sets the ip_addresses of this DeviceCreateInMetroInput.

        The `ip_addresses attribute will allow you to specify the addresses you want created with your device.  The default value configures public IPv4, public IPv6, and private IPv4.  Private IPv4 address is required. When specifying `ip_addresses`, one of the array items must enable private IPv4.  Some operating systems require public IPv4 address. In those cases you will receive an error message if public IPv4 is not enabled.  For example, to only configure your server with a private IPv4 address, you can send `{ \"ip_addresses\": [{ \"address_family\": 4, \"public\": false }] }`.  It is possible to request a subnet size larger than a `/30` by assigning addresses using the UUID(s) of ip_reservations in your project.  For example, `{ \"ip_addresses\": [..., {\"address_family\": 4, \"public\": true, \"ip_reservations\": [\"uuid1\", \"uuid2\"]}] }`  To access a server without public IPs, you can use our Out-of-Band console access (SOS) or proxy through another server in the project with public IPs enabled.  # noqa: E501

        :param ip_addresses: The ip_addresses of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def ipxe_script_url(self):
        """Gets the ipxe_script_url of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The ipxe_script_url of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def ipxe_script_url(self, ipxe_script_url):
        """Sets the ipxe_script_url of this DeviceCreateInMetroInput.

        When set, the device will chainload an iPXE Script at boot fetched from the supplied URL.  See [Custom iPXE](https://metal.equinix.com/developers/docs/operating-systems/custom-ipxe/) for more details.  # noqa: E501

        :param ipxe_script_url: The ipxe_script_url of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def locked(self):
        """Gets the locked of this DeviceCreateInMetroInput.  # noqa: E501

        Whether the device should be locked, preventing accidental deletion.  # noqa: E501

        :return: The locked of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: bool
        """
        return self._locked
    ...
    def locked(self, locked):
        """Sets the locked of this DeviceCreateInMetroInput.

        Whether the device should be locked, preventing accidental deletion.  # noqa: E501

        :param locked: The locked of this DeviceCreateInMetroInput.  # noqa: E501
        :type locked: bool
        """
    ...
    def no_ssh_keys(self):
        """Gets the no_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The no_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: bool
        """
    ...
    def no_ssh_keys(self, no_ssh_keys):
        """Sets the no_ssh_keys of this DeviceCreateInMetroInput.

        Overrides default behaviour of attaching all of the organization members ssh keys and project ssh keys to device if no specific keys specified  # noqa: E501

        :param no_ssh_keys: The no_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def operating_system(self):
        """Gets the operating_system of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The operating_system of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def operating_system(self, operating_system):
        """Sets the operating_system of this DeviceCreateInMetroInput.

        The slug of the operating system to provision. Check the Equinix Metal operating system documentation for rules that may be imposed per operating system, including restrictions on IP address options and device plans.  # noqa: E501

        :param operating_system: The operating_system of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def plan(self):
        """Gets the plan of this DeviceCreateInMetroInput.  # noqa: E501

        The slug of the device plan to provision.  # noqa: E501

        :return: The plan of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
        return self._plan
    ...
    @plan.setter
    def plan(self, plan):
        """Sets the plan of this DeviceCreateInMetroInput.

        The slug of the device plan to provision.  # noqa: E501

        :param plan: The plan of this DeviceCreateInMetroInput.  # noqa: E501
        :type plan: str
        """
    ...
    def private_ipv4_subnet_size(self):
        """Gets the private_ipv4_subnet_size of this DeviceCreateInMetroInput.  # noqa: E501

        Deprecated. Use ip_addresses. Subnet range for addresses allocated to this device.  # noqa: E501

        :return: The private_ipv4_subnet_size of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: float
        """
    ...
    def private_ipv4_subnet_size(self, private_ipv4_subnet_size):
        """Sets the private_ipv4_subnet_size of this DeviceCreateInMetroInput.

        Deprecated. Use ip_addresses. Subnet range for addresses allocated to this device.  # noqa: E501

        :param private_ipv4_subnet_size: The private_ipv4_subnet_size of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def project_ssh_keys(self):
        """Gets the project_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The project_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def project_ssh_keys(self, project_ssh_keys):
        """Sets the project_ssh_keys of this DeviceCreateInMetroInput.

        A list of UUIDs identifying the device parent project that should be authorized to access this device (typically via /root/.ssh/authorized_keys). These keys will also appear in the device metadata.  If no SSH keys are specified (`user_ssh_keys`, `project_ssh_keys`, and `ssh_keys` are all empty lists or omitted), all parent project keys, parent project members keys and organization members keys will be included. This behaviour can be changed with 'no_ssh_keys' option to omit any SSH key being added.   # noqa: E501

        :param project_ssh_keys: The project_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def public_ipv4_subnet_size(self):
        """Gets the public_ipv4_subnet_size of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The public_ipv4_subnet_size of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: float
        """
    ...
    def public_ipv4_subnet_size(self, public_ipv4_subnet_size):
        """Sets the public_ipv4_subnet_size of this DeviceCreateInMetroInput.

        Deprecated. Use ip_addresses. Subnet range for addresses allocated to this device. Your project must have addresses available for a non-default request.  # noqa: E501

        :param public_ipv4_subnet_size: The public_ipv4_subnet_size of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def spot_instance(self):
        """Gets the spot_instance of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The spot_instance of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: bool
        """
    ...
    def spot_instance(self, spot_instance):
        """Sets the spot_instance of this DeviceCreateInMetroInput.

        Create a spot instance. Spot instances are created with a maximum bid price. If the bid price is not met, the spot instance will be terminated as indicated by the `termination_time` field.  # noqa: E501

        :param spot_instance: The spot_instance of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def spot_price_max(self):
        """Gets the spot_price_max of this DeviceCreateInMetroInput.  # noqa: E501

        The maximum amount to bid for a spot instance.  # noqa: E501

        :return: The spot_price_max of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: float
        """
    ...
    def spot_price_max(self, spot_price_max):
        """Sets the spot_price_max of this DeviceCreateInMetroInput.

        The maximum amount to bid for a spot instance.  # noqa: E501

        :param spot_price_max: The spot_price_max of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def ssh_keys(self):
        """Gets the ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def ssh_keys(self, ssh_keys):
        """Sets the ssh_keys of this DeviceCreateInMetroInput.

        A list of new or existing project ssh_keys that should be authorized to access this device (typically via /root/.ssh/authorized_keys). These keys will also appear in the device metadata.  These keys are added in addition to any keys defined by   `project_ssh_keys` and `user_ssh_keys`.   # noqa: E501

        :param ssh_keys: The ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def tags(self):
        """Gets the tags of this DeviceCreateInMetroInput.  # noqa: E501


        :return: The tags of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: list[str]
        """
        return self._tags
    ...
    @tags.setter
    def tags(self, tags):
        """Sets the tags of this DeviceCreateInMetroInput.


        :param tags: The tags of this DeviceCreateInMetroInput.  # noqa: E501
        :type tags: list[str]
        """
    ...
    def termination_time(self):
        """Gets the termination_time of this DeviceCreateInMetroInput.  # noqa: E501


        :return: The termination_time of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: datetime
        """
    ...
    def termination_time(self, termination_time):
        """Sets the termination_time of this DeviceCreateInMetroInput.


        :param termination_time: The termination_time of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    def user_ssh_keys(self):
        """Gets the user_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The user_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def user_ssh_keys(self, user_ssh_keys):
        """Sets the user_ssh_keys of this DeviceCreateInMetroInput.

        A list of UUIDs identifying the users that should be authorized to access this device (typically via /root/.ssh/authorized_keys).  These keys will also appear in the device metadata.  The users must be members of the project or organization.  If no SSH keys are specified (`user_ssh_keys`, `project_ssh_keys`, and `ssh_keys` are all empty lists or omitted), all parent project keys, parent project members keys and organization members keys will be included. This behaviour can be changed with 'no_ssh_keys' option to omit any SSH key being added.   # noqa: E501

        :param user_ssh_keys: The user_ssh_keys of this DeviceCreateInMetroInput.  # noqa: E501
    ...
    @property
    def userdata(self):
        """Gets the userdata of this DeviceCreateInMetroInput.  # noqa: E501
        ...
        :return: The userdata of this DeviceCreateInMetroInput.  # noqa: E501
        :rtype: str
        """
    ...
    def userdata(self, userdata):
        """Sets the userdata of this DeviceCreateInMetroInput.

        The userdata presented in the metadata service for this device.  Userdata is fetched and interpreted by the operating system installed on the device. Acceptable formats are determined by the operating system, with the exception of a special iPXE enabling syntax which is handled before the operating system starts.  See [Server User Data](https://metal.equinix.com/developers/docs/servers/user-data/) and [Provisioning with Custom iPXE](https://metal.equinix.com/developers/docs/operating-systems/custom-ipxe/#provisioning-with-custom-ipxe) for more details.  # noqa: E501

        :param userdata: The userdata of this DeviceCreateInMetroInput.  # noqa: E501
        :type userdata: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceCreateInMetroInput):
            return False
