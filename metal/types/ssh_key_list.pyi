...
class SSHKeyList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ssh_keys", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ssh_keys", ], str]):
