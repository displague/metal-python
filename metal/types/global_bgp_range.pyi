...
class GlobalBgpRange(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address_family", "href", "id", "project", "range", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address_family", "href", "id", "project", "range", ], str]):
