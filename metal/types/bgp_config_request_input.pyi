...
class BgpConfigRequestInput(
    ...
    class MetaOapg:
        ...
        class properties:
            asn = schemas.IntSchema
            deployment_type = schemas.StrSchema
    ...
    deployment_type: MetaOapg.properties.deployment_type
    asn: MetaOapg.properties.asn
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asn", "deployment_type", "md5", "use_case", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["asn"]) -> MetaOapg.properties.asn: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["deployment_type"]) -> MetaOapg.properties.deployment_type: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asn", "deployment_type", "md5", "use_case", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        deployment_type: typing.Union[MetaOapg.properties.deployment_type, str, ],
        asn: typing.Union[MetaOapg.properties.asn, decimal.Decimal, int, ],
