...
class AuthToken(object):
    ...
    def __init__(self, created_at=None, description=None, id=None, project=None, read_only=None, token=None, updated_at=None, user=None, local_vars_configuration=None):  # noqa: E501
