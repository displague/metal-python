...
class OrganizationInput(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "billing_address", "customdata", "description", "enforce_2fa_at", "logo", "name", "twitter", "website", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "billing_address", "customdata", "description", "enforce_2fa_at", "logo", "name", "twitter", "website", ], str]):
