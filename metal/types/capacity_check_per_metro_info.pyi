...
class CapacityCheckPerMetroInfo(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["available", "metro", "plan", "quantity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["available", "metro", "plan", "quantity", ], str]):
