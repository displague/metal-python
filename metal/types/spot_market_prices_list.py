...
class SpotMarketPricesList(Model):
    ...
    def __init__(self, spot_market_prices: SpotPricesReport=None):
    ...
    @classmethod
    def from_dict(cls, dikt: dict) -> 'SpotMarketPricesList':
        """Returns the dict as a model

        :param dikt: A dict.
        :return: The SpotMarketPricesList of this SpotMarketPricesList.
        """
