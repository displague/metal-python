...
from ...models.license_list import LicenseList
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, LicenseList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = LicenseList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, LicenseList]]:
    return Response(
...
) -> Response[Union[Error, LicenseList]]:
...
) -> Optional[Union[Error, LicenseList]]:
    """Retrieve all licenses
