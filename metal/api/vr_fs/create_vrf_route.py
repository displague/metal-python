...
from ...models.vrf_route_create_input import VrfRouteCreateInput
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, VrfRoute]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = VrfRoute.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Notice: VRFs are a test feature currently under active development, and only available to certain
    users. Please contact Customer Success for more information.
