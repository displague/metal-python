...
from ...models.vrf_route_list import VrfRouteList
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, VrfRouteList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = VrfRouteList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, VrfRouteList]]:
    return Response(
...
) -> Response[Union[Error, VrfRouteList]]:
...
) -> Optional[Union[Error, VrfRouteList]]:
    """Retrieve all routes in the VRF
