...
from ...models.vrf_list import VrfList
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, VrfList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = VrfList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, VrfList]]:
    return Response(
