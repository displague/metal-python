...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/connections/{connection_id}/ports/{id}/events".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, Event]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, Event]]:
    return Response(
