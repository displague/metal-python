...
from ...models.transfer_request_list import TransferRequestList
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/organizations/{id}/transfers".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, TransferRequestList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = TransferRequestList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, TransferRequestList]]:
    return Response(
...
) -> Response[Union[Error, TransferRequestList]]:
...
) -> Optional[Union[Error, TransferRequestList]]:
    """Retrieve all project transfer requests from or to an organization
