...
from ...models.payment_method_list import PaymentMethodList
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, PaymentMethodList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = PaymentMethodList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, PaymentMethodList]]:
    return Response(
...
) -> Response[Union[Error, PaymentMethodList]]:
...
) -> Optional[Union[Error, PaymentMethodList]]:
    """Retrieve all payment methods of an organization
