...
from ...models.find_plans_type import FindPlansType
...
def _get_kwargs(
    *,
    client: Client,
    type: Union[Unset, None, FindPlansType] = UNSET,
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, PlanList]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, PlanList]]:
    return Response(
...
) -> Response[Union[Error, PlanList]]:
    """Retrieve all plans

     Provides a listing of available plans to provision your device on.

    Args:
        type (Union[Unset, None, FindPlansType]):  Example: standard.
