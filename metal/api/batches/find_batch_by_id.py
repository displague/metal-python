...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Batch, Error]]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Batch, Error]]:
    return Response(
