...
from ...models.auth_token_list import AuthTokenList
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[AuthTokenList, Error]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = AuthTokenList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[AuthTokenList, Error]]:
    return Response(
...
) -> Response[Union[AuthTokenList, Error]]:
...
) -> Optional[Union[AuthTokenList, Error]]:
    """Retrieve all API keys for the project.
