...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[Union[Error, MembershipList]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = MembershipList.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[Union[Error, MembershipList]]:
    return Response(
...
) -> Response[Union[Error, MembershipList]]:
...
) -> Optional[Union[Error, MembershipList]]:
    """Retrieve project memberships
