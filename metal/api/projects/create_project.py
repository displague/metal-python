...
from ...models.project_create_from_root_input import ProjectCreateFromRootInput
...
def _get_kwargs(
    *,
    client: Client,
    json_body: ProjectCreateFromRootInput,
...
def sync_detailed(
    *,
    ...
    """Create a project
     ...
     Creates a new project for the user default organization. If the user don't have an organization, a
