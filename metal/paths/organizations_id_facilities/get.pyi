...
SchemaFor200ResponseBodyApplicationJson = FacilityList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_facilities_by_organization_oapg(
        self,
...
class FindFacilitiesByOrganization(BaseApi):
    ...
    def find_facilities_by_organization(
        ...
        return self._find_facilities_by_organization_oapg(
