...
# body param
SchemaForRequestBodyApplicationJson = IPAssignmentUpdateInput


request_body_ip_assignment_update_input = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = FindIPAddressById200Response
...
class BaseApi(api_client.Api):
    ...
    def _update_ip_address_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_ip_assignment_update_input.serialize(body, content_type)
...
class UpdateIpAddress(BaseApi):
    ...
    def update_ip_address(
        ...
        return self._update_ip_address_oapg(
            body=body,
