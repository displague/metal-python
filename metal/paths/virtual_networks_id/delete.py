...
SchemaFor200ResponseBodyApplicationJson = VirtualNetwork
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_virtual_network_oapg(
        self,
...
class DeleteVirtualNetwork(BaseApi):
    ...
    def delete_virtual_network(
        ...
        return self._delete_virtual_network_oapg(
