...
class BucketSchema(
    ...
    def EXTERNAL(cls):
        return cls("external")
TimeframeSchema = FindTrafficTimeframeParameter
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'bucket': typing.Union[BucketSchema, str, ],
        'timeframe': typing.Union[TimeframeSchema, ],
    },
    total=False
)
...
request_query_bucket = api_client.QueryParameter(
    name="bucket",
    style=api_client.ParameterStyle.FORM,
    schema=BucketSchema,
    explode=True,
)
request_query_timeframe = api_client.QueryParameter(
    name="timeframe",
...
class BaseApi(api_client.Api):
    ...
    def _find_traffic_oapg(
        ...
        for parameter in (
            ...
            request_query_bucket,
            request_query_timeframe,
        ):
...
class FindTraffic(BaseApi):
    ...
    def find_traffic(
        ...
        return self._find_traffic_oapg(
