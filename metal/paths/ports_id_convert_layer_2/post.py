...
# body param
SchemaForRequestBodyApplicationJson = PortAssignInput


request_body_port_assign_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _convert_layer2_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_port_assign_input.serialize(body, content_type)
...
class ConvertLayer2(BaseApi):
    ...
    def convert_layer2(
        ...
        return self._convert_layer2_oapg(
            body=body,
