...
SchemaFor200ResponseBodyApplicationJson = TransferRequestList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_transfers_oapg(
        self,
...
class FindOrganizationTransfers(BaseApi):
    ...
    def find_organization_transfers(
        ...
        return self._find_organization_transfers_oapg(
