...
# body param
SchemaForRequestBodyApplicationJson = IPAssignmentInput


request_body_ip_assignment_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = IPAssignment
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_ip_assignment_oapg(
        self,
    ...
    def _create_ip_assignment_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ip_assignment_input.serialize(body, content_type)
...
class CreateIpAssignment(BaseApi):
    ...
    def create_ip_assignment(
        ...
        return self._create_ip_assignment_oapg(
            body=body,
