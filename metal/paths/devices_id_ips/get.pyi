...
SchemaFor200ResponseBodyApplicationJson = IPAssignmentList
...
class FindIpAssignments(BaseApi):
    ...
    def find_ip_assignments(
        ...
        return self._find_ip_assignments_oapg(
