...
# body param
SchemaForRequestBodyApplicationJson = UserUpdateInput


request_body_user_update_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_current_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_update_input.serialize(body, content_type)
...
class UpdateCurrentUser(BaseApi):
    ...
    def update_current_user(
        ...
        return self._update_current_user_oapg(
            body=body,
