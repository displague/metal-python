...
# body param
SchemaForRequestBodyApplicationJson = TransferRequestInput


request_body_transfer_request_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = TransferRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_transfer_request_oapg(
        self,
    ...
    def _create_transfer_request_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_transfer_request_input.serialize(body, content_type)
...
class CreateTransferRequest(BaseApi):
    ...
    def create_transfer_request(
        ...
        return self._create_transfer_request_oapg(
            body=body,
