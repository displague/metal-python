...
SchemaFor202ResponseBodyApplicationJson = Interconnection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_interconnection_oapg(
        self,
...
class DeleteInterconnection(BaseApi):
    ...
    def delete_interconnection(
        ...
        return self._delete_interconnection_oapg(
