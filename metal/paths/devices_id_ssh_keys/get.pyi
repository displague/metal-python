...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'Search string': typing.Union[SearchStringSchema, str, ],
...
SchemaFor200ResponseBodyApplicationJson = SSHKeyList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_device_ssh_keys_oapg(
        self,
...
class FindDeviceSshKeys(BaseApi):
    ...
    def find_device_ssh_keys(
        ...
        return self._find_device_ssh_keys_oapg(
