...
# Query params
CreatedAfterSchema = schemas.StrSchema
CreatedBeforeSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'created[after]': typing.Union[CreatedAfterSchema, str, ],
        'created[before]': typing.Union[CreatedBeforeSchema, str, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = ProjectUsageList
...
class FindProjectUsage(BaseApi):
    ...
    def find_project_usage(
        ...
        return self._find_project_usage_oapg(
