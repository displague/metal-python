...
SchemaFor200ResponseBodyApplicationJson = Metadata
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_device_metadata_by_id_oapg(
        self,
...
class FindDeviceMetadataById(BaseApi):
    ...
    def find_device_metadata_by_id(
        ...
        return self._find_device_metadata_by_id_oapg(
