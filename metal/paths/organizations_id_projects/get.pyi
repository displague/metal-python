...
SchemaFor200ResponseBodyApplicationJson = ProjectList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_projects_oapg(
        self,
...
class FindOrganizationProjects(BaseApi):
    ...
    def find_organization_projects(
        ...
        return self._find_organization_projects_oapg(
