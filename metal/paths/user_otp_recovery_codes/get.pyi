...
SchemaFor200ResponseBodyApplicationJson = RecoveryCodeList
...
class FindRecoveryCodes(BaseApi):
    ...
    def find_recovery_codes(
        ...
        return self._find_recovery_codes_oapg(
