...
SchemaFor200ResponseBodyApplicationJson = OperatingSystemList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_operating_systems_by_organization_oapg(
        self,
...
class FindOperatingSystemsByOrganization(BaseApi):
    ...
    def find_operating_systems_by_organization(
        ...
        return self._find_operating_systems_by_organization_oapg(
