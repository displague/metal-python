...
SchemaFor200ResponseBodyApplicationJson = IPReservationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_ip_reservations_oapg(
        self,
...
class FindIpReservations(BaseApi):
    ...
    def find_ip_reservations(
        ...
        return self._find_ip_reservations_oapg(
