...
# body param
SchemaForRequestBodyApplicationJson = RequestIPReservationRequest


request_body_request_ip_reservation_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = RequestIPReservation201Response
...
class BaseApi(api_client.Api):
    @typing.overload
    def _request_ip_reservation_oapg(
        self,
    ...
    def _request_ip_reservation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_request_ip_reservation_request.serialize(body, content_type)
...
class RequestIpReservation(BaseApi):
    ...
    def request_ip_reservation(
        ...
        return self._request_ip_reservation_oapg(
            body=body,
