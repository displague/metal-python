...
# body param
SchemaForRequestBodyApplicationJson = LicenseUpdateInput


request_body_license_update_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = License
...
class BaseApi(api_client.Api):
    ...
    def _update_license_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_license_update_input.serialize(body, content_type)
...
class UpdateLicense(BaseApi):
    ...
    def update_license(
        ...
        return self._update_license_oapg(
            body=body,
