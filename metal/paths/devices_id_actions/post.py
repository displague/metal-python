...
# body param
SchemaForRequestBodyApplicationJson = DeviceActionInput


request_body_device_action_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _perform_action_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_device_action_input.serialize(body, content_type)
...
class PerformAction(BaseApi):
    ...
    def perform_action(
        ...
        return self._perform_action_oapg(
            body=body,
