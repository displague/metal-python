...
# body param
SchemaForRequestBodyApplicationJson = PortVlanAssignmentBatchCreateInput


request_body_port_vlan_assignment_batch_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PortVlanAssignmentBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_port_vlan_assignment_batch_oapg(
        self,
    ...
    def _create_port_vlan_assignment_batch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_port_vlan_assignment_batch_create_input.serialize(body, content_type)
...
class CreatePortVlanAssignmentBatch(BaseApi):
    ...
    def create_port_vlan_assignment_batch(
        ...
        return self._create_port_vlan_assignment_batch_oapg(
            body=body,
