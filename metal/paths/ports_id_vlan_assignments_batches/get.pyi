...
SchemaFor200ResponseBodyApplicationJson = PortVlanAssignmentBatchList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_port_vlan_assignment_batches_oapg(
        self,
...
class FindPortVlanAssignmentBatches(BaseApi):
    ...
    def find_port_vlan_assignment_batches(
        ...
        return self._find_port_vlan_assignment_batches_oapg(
