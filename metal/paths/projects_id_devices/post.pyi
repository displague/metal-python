...
# body param
SchemaForRequestBodyApplicationJson = CreateDeviceRequest


request_body_create_device_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_device_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_device_request.serialize(body, content_type)
