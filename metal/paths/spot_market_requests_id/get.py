...
SchemaFor200ResponseBodyApplicationJson = SpotMarketRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_spot_market_request_by_id_oapg(
        self,
...
class FindSpotMarketRequestById(BaseApi):
    ...
    def find_spot_market_request_by_id(
        ...
        return self._find_spot_market_request_by_id_oapg(
