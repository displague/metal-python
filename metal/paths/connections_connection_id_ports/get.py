...
SchemaFor200ResponseBodyApplicationJson = InterconnectionPortList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_interconnection_ports_oapg(
        self,
...
class ListInterconnectionPorts(BaseApi):
    ...
    def list_interconnection_ports(
        ...
        return self._list_interconnection_ports_oapg(
