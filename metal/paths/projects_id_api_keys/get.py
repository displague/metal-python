...
SchemaFor200ResponseBodyApplicationJson = AuthTokenList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_project_api_keys_oapg(
        self,
...
class FindProjectApiKeys(BaseApi):
    ...
    def find_project_api_keys(
        ...
        return self._find_project_api_keys_oapg(
