...
# body param
SchemaForRequestBodyApplicationJson = AuthTokenInput


request_body_auth_token_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = AuthToken
...
class BaseApi(api_client.Api):
    ...
    def _create_api_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_auth_token_input.serialize(body, content_type)
