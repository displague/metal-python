...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'personal': typing.Union[PersonalSchema, str, ],
        'without_projects': typing.Union[WithoutProjectsSchema, str, ],
...
request_query_personal = api_client.QueryParameter(
    name="personal",
    style=api_client.ParameterStyle.FORM,
    schema=PersonalSchema,
    explode=True,
)
request_query_without_projects = api_client.QueryParameter(
    name="without_projects",
    style=api_client.ParameterStyle.FORM,
    schema=WithoutProjectsSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = OrganizationList
...
class BaseApi(api_client.Api):
    ...
    def _find_organizations_oapg(
        ...
        for parameter in (
            request_query_personal,
            request_query_without_projects,
...
class FindOrganizations(BaseApi):
    ...
    def find_organizations(
        ...
        return self._find_organizations_oapg(
