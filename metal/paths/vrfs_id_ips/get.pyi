...
SchemaFor200ResponseBodyApplicationJson = VrfIpReservationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_vrf_ip_reservations_oapg(
        self,
...
class FindVrfIpReservations(BaseApi):
    ...
    def find_vrf_ip_reservations(
        ...
        return self._find_vrf_ip_reservations_oapg(
