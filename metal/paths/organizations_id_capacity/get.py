...
SchemaFor200ResponseBodyApplicationJson = CapacityList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_capacity_per_facility_oapg(
        self,
...
class FindOrganizationCapacityPerFacility(BaseApi):
    ...
    def find_organization_capacity_per_facility(
        ...
        return self._find_organization_capacity_per_facility_oapg(
