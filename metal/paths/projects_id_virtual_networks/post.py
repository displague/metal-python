...
# body param
SchemaForRequestBodyApplicationJson = VirtualNetworkCreateInput


request_body_virtual_network_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = VirtualNetwork
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_virtual_network_oapg(
        self,
    ...
    def _create_virtual_network_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_virtual_network_create_input.serialize(body, content_type)
...
class CreateVirtualNetwork(BaseApi):
    ...
    def create_virtual_network(
        ...
        return self._create_virtual_network_oapg(
            body=body,
