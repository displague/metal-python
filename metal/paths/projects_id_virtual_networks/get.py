...
SchemaFor200ResponseBodyApplicationJson = VirtualNetworkList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_virtual_networks_oapg(
        self,
...
class FindVirtualNetworks(BaseApi):
    ...
    def find_virtual_networks(
        ...
        return self._find_virtual_networks_oapg(
