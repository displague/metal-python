...
# body param
SchemaForRequestBodyApplicationJson = SupportRequestInput


request_body_support_request_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _request_suppert_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_support_request_input.serialize(body, content_type)
...
class RequestSuppert(BaseApi):
    ...
    def request_suppert(
        ...
        return self._request_suppert_oapg(
            body=body,
