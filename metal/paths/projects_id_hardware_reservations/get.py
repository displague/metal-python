...
class StateSchema(
    ...
    @schemas.classproperty
    def NEED_OF_SERVICE(cls):
        return cls("need_of_service")


class ProvisionableSchema(
    schemas.EnumBase,
    schemas.StrSchema
):
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'provisionable': typing.Union[ProvisionableSchema, str, ],
...
request_query_provisionable = api_client.QueryParameter(
    name="provisionable",
    style=api_client.ParameterStyle.FORM,
    schema=ProvisionableSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = HardwareReservationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_project_hardware_reservations_oapg(
        self,
...
class FindProjectHardwareReservations(BaseApi):
    ...
    def find_project_hardware_reservations(
        ...
        return self._find_project_hardware_reservations_oapg(
