...
SchemaFor200ResponseBodyApplicationJson = LicenseList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_project_licenses_oapg(
        self,
...
class FindProjectLicenses(BaseApi):
    ...
    def find_project_licenses(
        ...
        return self._find_project_licenses_oapg(
