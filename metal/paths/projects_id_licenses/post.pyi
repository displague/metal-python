...
# body param
SchemaForRequestBodyApplicationJson = LicenseCreateInput


request_body_license_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = License
...
class BaseApi(api_client.Api):
    ...
    def _create_license_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_license_create_input.serialize(body, content_type)
