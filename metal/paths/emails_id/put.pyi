...
# body param
SchemaForRequestBodyApplicationJson = UpdateEmailInput


request_body_update_email_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Email
...
class BaseApi(api_client.Api):
    ...
    def _update_email_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_email_input.serialize(body, content_type)
...
class UpdateEmail(BaseApi):
    ...
    def update_email(
        ...
        return self._update_email_oapg(
            body=body,
