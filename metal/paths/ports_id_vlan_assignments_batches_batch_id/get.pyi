...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'batch_id': typing.Union[BatchIdSchema, str, uuid.UUID, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = PortVlanAssignmentBatch
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_port_vlan_assignment_batch_by_port_id_and_batch_id_oapg(
        self,
...
class FindPortVlanAssignmentBatchByPortIdAndBatchId(BaseApi):
    ...
    def find_port_vlan_assignment_batch_by_port_id_and_batch_id(
        ...
        return self._find_port_vlan_assignment_batch_by_port_id_and_batch_id_oapg(
