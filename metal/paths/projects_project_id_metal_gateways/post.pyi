...
# body param
SchemaForRequestBodyApplicationJson = CreateMetalGatewayRequest


request_body_create_metal_gateway_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = FindMetalGatewayById200Response
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_metal_gateway_oapg(
        self,
    ...
    def _create_metal_gateway_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_create_metal_gateway_request.serialize(body, content_type)
...
class CreateMetalGateway(BaseApi):
    ...
    def create_metal_gateway(
        ...
        return self._create_metal_gateway_oapg(
            body=body,
