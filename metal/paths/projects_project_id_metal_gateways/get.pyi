...
SchemaFor200ResponseBodyApplicationJson = MetalGatewayList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_metal_gateways_by_project_oapg(
        self,
...
class FindMetalGatewaysByProject(BaseApi):
    ...
    def find_metal_gateways_by_project(
        ...
        return self._find_metal_gateways_by_project_oapg(
