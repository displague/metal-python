...
# body param
SchemaForRequestBodyApplicationJson = SSHKeyCreateInput


request_body_ssh_key_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = SSHKey
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_project_ssh_key_oapg(
        self,
    ...
    def _create_project_ssh_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ssh_key_create_input.serialize(body, content_type)
...
class CreateProjectSshKey(BaseApi):
    ...
    def create_project_ssh_key(
        ...
        return self._create_project_ssh_key_oapg(
            body=body,
