...
# body param
SchemaForRequestBodyApplicationJson = ProjectUpdateInput


request_body_project_update_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_project_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_update_input.serialize(body, content_type)
