...
# body param
SchemaForRequestBodyApplicationJson = BgpConfigRequestInput


request_body_bgp_config_request_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _request_bgp_config_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bgp_config_request_input.serialize(body, content_type)
...
class RequestBgpConfig(BaseApi):
    ...
    def request_bgp_config(
        ...
        return self._request_bgp_config_oapg(
            body=body,
