...
SchemaFor200ResponseBodyApplicationJson = BgpSessionNeighbors
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_bgp_neighbor_data_oapg(
        self,
...
class GetBgpNeighborData(BaseApi):
    ...
    def get_bgp_neighbor_data(
        ...
        return self._get_bgp_neighbor_data_oapg(
