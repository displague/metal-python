...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_interconnection_virtual_circuits_oapg(
        self,
...
class ListInterconnectionVirtualCircuits(BaseApi):
    ...
    def list_interconnection_virtual_circuits(
        ...
        return self._list_interconnection_virtual_circuits_oapg(
