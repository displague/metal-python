...
SchemaFor200ResponseBodyApplicationJson = SelfServiceReservationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_self_service_reservations_oapg(
        self,
...
class FindSelfServiceReservations(BaseApi):
    ...
    def find_self_service_reservations(
        ...
        return self._find_self_service_reservations_oapg(
