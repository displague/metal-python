...
# body param
SchemaForRequestBodyApplicationJson = ProjectCreateFromRootInput


request_body_project_create_from_root_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_project_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_project_create_from_root_input.serialize(body, content_type)
