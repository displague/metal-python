...
# body param
SchemaForRequestBodyApplicationJson = DeviceUpdateInput


request_body_device_update_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_device_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_device_update_input.serialize(body, content_type)
...
class UpdateDevice(BaseApi):
    ...
    def update_device(
        ...
        return self._update_device_oapg(
            body=body,
