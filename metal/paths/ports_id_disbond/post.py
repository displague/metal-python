...
# Query params
BulkDisableSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'bulk_disable': typing.Union[BulkDisableSchema, bool, ],
    },
    total=False
)
...
request_query_bulk_disable = api_client.QueryParameter(
    name="bulk_disable",
    style=api_client.ParameterStyle.FORM,
    schema=BulkDisableSchema,
    explode=True,
)
# Path params
...
class DisbondPort(BaseApi):
    ...
    def disbond_port(
        ...
        return self._disbond_port_oapg(
