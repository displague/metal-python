...
# body param
SchemaForRequestBodyApplicationJson = PortConvertLayer3Input


request_body_port_convert_layer3_input = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = Port
...
class BaseApi(api_client.Api):
    ...
    def _convert_layer3_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_port_convert_layer3_input.serialize(body, content_type)
...
class ConvertLayer3(BaseApi):
    ...
    def convert_layer3(
        ...
        return self._convert_layer3_oapg(
            body=body,
