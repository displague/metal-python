...
SchemaFor200ResponseBodyApplicationJson = Invitation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_invitation_by_id_oapg(
        self,
...
class FindInvitationById(BaseApi):
    ...
    def find_invitation_by_id(
        ...
        return self._find_invitation_by_id_oapg(
