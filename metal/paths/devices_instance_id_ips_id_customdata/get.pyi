...
# Path params
InstanceIdSchema = schemas.UUIDSchema
IdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'instance_id': typing.Union[InstanceIdSchema, str, uuid.UUID, ],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_ip_assignment_customdata_oapg(
        self,
...
class FindIpAssignmentCustomdata(BaseApi):
    ...
    def find_ip_assignment_customdata(
        ...
        return self._find_ip_assignment_customdata_oapg(
