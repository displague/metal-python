...
SchemaFor200ResponseBodyApplicationJson = MembershipList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_project_memberships_oapg(
        self,
...
class FindProjectMemberships(BaseApi):
    ...
    def find_project_memberships(
        ...
        return self._find_project_memberships_oapg(
