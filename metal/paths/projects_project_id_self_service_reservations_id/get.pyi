...
SchemaFor200ResponseBodyApplicationJson = SelfServiceReservationResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_self_service_reservation_oapg(
        self,
...
class FindSelfServiceReservation(BaseApi):
    ...
    def find_self_service_reservation(
        ...
        return self._find_self_service_reservation_oapg(
