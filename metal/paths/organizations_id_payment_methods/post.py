...
# body param
SchemaForRequestBodyApplicationJson = PaymentMethodCreateInput


request_body_payment_method_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = PaymentMethod
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_payment_method_oapg(
        self,
    ...
    def _create_payment_method_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_payment_method_create_input.serialize(body, content_type)
...
class CreatePaymentMethod(BaseApi):
    ...
    def create_payment_method(
        ...
        return self._create_payment_method_oapg(
            body=body,
