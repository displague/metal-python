...
SchemaFor200ResponseBodyApplicationJson = PaymentMethodList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_payment_methods_oapg(
        self,
...
class FindOrganizationPaymentMethods(BaseApi):
    ...
    def find_organization_payment_methods(
        ...
        return self._find_organization_payment_methods_oapg(
