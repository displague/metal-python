...
# body param
SchemaForRequestBodyApplicationJson = SpotMarketRequestCreateInput


request_body_spot_market_request_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = SpotMarketRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_spot_market_request_oapg(
        self,
    ...
    def _create_spot_market_request_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_spot_market_request_create_input.serialize(body, content_type)
...
class CreateSpotMarketRequest(BaseApi):
    ...
    def create_spot_market_request(
        ...
        return self._create_spot_market_request_oapg(
            body=body,
