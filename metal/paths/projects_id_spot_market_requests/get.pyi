...
SchemaFor200ResponseBodyApplicationJson = SpotMarketRequestList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _list_spot_market_requests_oapg(
        self,
...
class ListSpotMarketRequests(BaseApi):
    ...
    def list_spot_market_requests(
        ...
        return self._list_spot_market_requests_oapg(
