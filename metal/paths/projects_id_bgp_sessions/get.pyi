...
SchemaFor200ResponseBodyApplicationJson = BgpSessionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_project_bgp_sessions_oapg(
        self,
...
class FindProjectBgpSessions(BaseApi):
    ...
    def find_project_bgp_sessions(
        ...
        return self._find_project_bgp_sessions_oapg(
