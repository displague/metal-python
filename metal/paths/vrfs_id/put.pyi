...
# body param
SchemaForRequestBodyApplicationJson = VrfUpdateInput


request_body_vrf_update_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Vrf
...
class BaseApi(api_client.Api):
    ...
    def _update_vrf_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_vrf_update_input.serialize(body, content_type)
