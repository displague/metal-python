...
SchemaFor200ResponseBodyApplicationJson = BgpSession
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_bgp_session_by_id_oapg(
        self,
...
class FindBgpSessionById(BaseApi):
    ...
    def find_bgp_session_by_id(
        ...
        return self._find_bgp_session_by_id_oapg(
