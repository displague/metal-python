...
SchemaFor200ResponseBodyApplicationJson = InvitationList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_invitations_oapg(
        self,
...
class FindOrganizationInvitations(BaseApi):
    ...
    def find_organization_invitations(
        ...
        return self._find_organization_invitations_oapg(
