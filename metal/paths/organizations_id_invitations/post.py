...
# body param
SchemaForRequestBodyApplicationJson = InvitationInput


request_body_invitation_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Invitation
...
class BaseApi(api_client.Api):
    ...
    def _create_organization_invitation_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_invitation_input.serialize(body, content_type)
