...
SchemaFor200ResponseBodyApplicationJson = BatchesList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_batches_by_project_oapg(
        self,
...
class FindBatchesByProject(BaseApi):
    ...
    def find_batches_by_project(
        ...
        return self._find_batches_by_project_oapg(
