...
# Path params
VrfIdSchema = schemas.UUIDSchema
IdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'vrf_id': typing.Union[VrfIdSchema, str, uuid.UUID, ],
...
request_path_vrf_id = api_client.PathParameter(
    name="vrf_id",
...
SchemaFor200ResponseBodyApplicationJson = VrfIpReservation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_vrf_ip_reservation_oapg(
        self,
...
class FindVrfIpReservation(BaseApi):
    ...
    def find_vrf_ip_reservation(
        ...
        return self._find_vrf_ip_reservation_oapg(
