...
# body param
SchemaForRequestBodyApplicationJson = ActivateHardwareReservationRequest


request_body_activate_hardware_reservation_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = HardwareReservation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _activate_hardware_reservation_oapg(
        self,
    ...
    def _activate_hardware_reservation_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_activate_hardware_reservation_request.serialize(body, content_type)
...
class ActivateHardwareReservation(BaseApi):
    ...
    def activate_hardware_reservation(
        ...
        return self._activate_hardware_reservation_oapg(
            body=body,
