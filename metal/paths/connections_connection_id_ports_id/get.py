...
SchemaFor200ResponseBodyApplicationJson = InterconnectionPort
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_interconnection_port_oapg(
        self,
...
class GetInterconnectionPort(BaseApi):
    ...
    def get_interconnection_port(
        ...
        return self._get_interconnection_port_oapg(
