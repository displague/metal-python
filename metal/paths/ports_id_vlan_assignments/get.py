...
SchemaFor200ResponseBodyApplicationJson = PortVlanAssignmentList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_port_vlan_assignments_oapg(
        self,
...
class FindPortVlanAssignments(BaseApi):
    ...
    def find_port_vlan_assignments(
        ...
        return self._find_port_vlan_assignments_oapg(
