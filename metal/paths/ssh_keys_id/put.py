...
# body param
SchemaForRequestBodyApplicationJson = SSHKeyInput


request_body_ssh_key_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SSHKey
...
class BaseApi(api_client.Api):
    ...
    def _update_ssh_key_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_ssh_key_input.serialize(body, content_type)
