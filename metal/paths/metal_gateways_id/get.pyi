...
SchemaFor200ResponseBodyApplicationJson = FindMetalGatewayById200Response
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_metal_gateway_by_id_oapg(
        self,
...
class FindMetalGatewayById(BaseApi):
    ...
    def find_metal_gateway_by_id(
        ...
        return self._find_metal_gateway_by_id_oapg(
