...
SchemaFor202ResponseBodyApplicationJson = FindMetalGatewayById200Response
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_metal_gateway_oapg(
        self,
...
class DeleteMetalGateway(BaseApi):
    ...
    def delete_metal_gateway(
        ...
        return self._delete_metal_gateway_oapg(
