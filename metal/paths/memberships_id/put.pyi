...
# body param
SchemaForRequestBodyApplicationJson = MembershipInput


request_body_membership_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Membership
...
class BaseApi(api_client.Api):
    ...
    def _update_membership_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_membership_input.serialize(body, content_type)
