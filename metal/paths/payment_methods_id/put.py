...
# body param
SchemaForRequestBodyApplicationJson = PaymentMethodUpdateInput


request_body_payment_method_update_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = PaymentMethod
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_payment_method_oapg(
        self,
    ...
    def _update_payment_method_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_payment_method_update_input.serialize(body, content_type)
...
class UpdatePaymentMethod(BaseApi):
    ...
    def update_payment_method(
        ...
        return self._update_payment_method_oapg(
            body=body,
