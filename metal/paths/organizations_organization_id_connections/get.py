...
SchemaFor200ResponseBodyApplicationJson = InterconnectionList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _organization_list_interconnections_oapg(
        self,
...
class OrganizationListInterconnections(BaseApi):
    ...
    def organization_list_interconnections(
        ...
        return self._organization_list_interconnections_oapg(
