...
# body param
SchemaForRequestBodyApplicationJson = InterconnectionCreateInput


request_body_interconnection_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Interconnection
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_organization_interconnection_oapg(
        self,
    ...
    def _create_organization_interconnection_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_interconnection_create_input.serialize(body, content_type)
...
class CreateOrganizationInterconnection(BaseApi):
    ...
    def create_organization_interconnection(
        ...
        return self._create_organization_interconnection_oapg(
            body=body,
