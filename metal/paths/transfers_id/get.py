...
SchemaFor200ResponseBodyApplicationJson = TransferRequest
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_transfer_request_by_id_oapg(
        self,
...
class FindTransferRequestById(BaseApi):
    ...
    def find_transfer_request_by_id(
        ...
        return self._find_transfer_request_by_id_oapg(
