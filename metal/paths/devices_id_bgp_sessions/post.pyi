...
# body param
SchemaForRequestBodyApplicationJson = BGPSessionInput


request_body_bgp_session_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = BgpSession
...
class BaseApi(api_client.Api):
    ...
    def _create_bgp_session_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_bgp_session_input.serialize(body, content_type)
...
class CreateBgpSession(BaseApi):
    ...
    def create_bgp_session(
        ...
        return self._create_bgp_session_oapg(
            body=body,
