...
SchemaFor200ResponseBodyApplicationJson = MetroCapacityList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_capacity_per_metro_oapg(
        self,
...
class FindOrganizationCapacityPerMetro(BaseApi):
    ...
    def find_organization_capacity_per_metro(
        ...
        return self._find_organization_capacity_per_metro_oapg(
