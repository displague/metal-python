...
SchemaFor200ResponseBodyApplicationJson = HardwareReservation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_hardware_reservation_by_id_oapg(
        self,
...
class FindHardwareReservationById(BaseApi):
    ...
    def find_hardware_reservation_by_id(
        ...
        return self._find_hardware_reservation_by_id_oapg(
