...
SchemaFor202ResponseBodyApplicationJson = VrfRoute
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_vrf_route_by_id_oapg(
        self,
...
class DeleteVrfRouteById(BaseApi):
    ...
    def delete_vrf_route_by_id(
        ...
        return self._delete_vrf_route_by_id_oapg(
