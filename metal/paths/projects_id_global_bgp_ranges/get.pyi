...
SchemaFor200ResponseBodyApplicationJson = GlobalBgpRangeList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_global_bgp_ranges_oapg(
        self,
...
class FindGlobalBgpRanges(BaseApi):
    ...
    def find_global_bgp_ranges(
        ...
        return self._find_global_bgp_ranges_oapg(
