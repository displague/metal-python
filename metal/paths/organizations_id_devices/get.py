...
ReservedSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'reserved': typing.Union[ReservedSchema, bool, ],
...
request_query_reserved = api_client.QueryParameter(
    name="reserved",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = DeviceList
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_organization_devices_oapg(
        self,
...
class FindOrganizationDevices(BaseApi):
    ...
    def find_organization_devices(
        ...
        return self._find_organization_devices_oapg(
