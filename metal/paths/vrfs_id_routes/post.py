...
# body param
SchemaForRequestBodyApplicationJson = VrfRouteCreateInput


request_body_vrf_route_create_input = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = VrfRoute
...
class BaseApi(api_client.Api):
    ...
    def _create_vrf_route_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_vrf_route_create_input.serialize(body, content_type)
...
class CreateVrfRoute(BaseApi):
    ...
    def create_vrf_route(
        ...
        return self._create_vrf_route_oapg(
            body=body,
