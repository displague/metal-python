...
SchemaFor200ResponseBodyApplicationJson = BgpConfig
...
class BaseApi(api_client.Api):
    @typing.overload
    def _find_bgp_config_by_project_oapg(
        self,
...
class FindBgpConfigByProject(BaseApi):
    ...
    def find_bgp_config_by_project(
        ...
        return self._find_bgp_config_by_project_oapg(
