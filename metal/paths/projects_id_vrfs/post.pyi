...
# body param
SchemaForRequestBodyApplicationJson = VrfCreateInput


request_body_vrf_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Vrf
...
class BaseApi(api_client.Api):
    ...
    def _create_vrf_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_vrf_create_input.serialize(body, content_type)
