...
# body param
SchemaForRequestBodyApplicationJson = UserCreateInput


request_body_user_create_input = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_user_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_user_create_input.serialize(body, content_type)
