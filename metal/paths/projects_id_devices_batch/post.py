...
# body param
SchemaForRequestBodyApplicationJson = InstancesBatchCreateInput


request_body_instances_batch_create_input = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = BatchesList
...
class BaseApi(api_client.Api):
    ...
    def _create_device_batch_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_instances_batch_create_input.serialize(body, content_type)
...
class CreateDeviceBatch(BaseApi):
    ...
    def create_device_batch(
        ...
        return self._create_device_batch_oapg(
            body=body,
